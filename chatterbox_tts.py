...
#   --voice-key "voices/system/cmsq8i70200001eg2net5z86n"

# Use this to test CURL:
# curl -X POST "https://har-ness-0--chatterbox-tts-chatterbox-serve.modal.run/generate" \
#   -H "Content-Type: application/json" \
#   -H "X-Api-Key: peoofzSwybTxrrPgG575bde7efdv2qBp" \
#   -d '{"prompt": "Innovex is back, and it’s bringing three days of competition, strategy, and innovation. Six sub-events, each designed around a different area of expertise. Financial Feat — putting financial knowledge and decision-making to the test. Legal Symposium — exploring ideas through logic, analysis, and argument. Marketing Maven — where creative thinking drives communication and impact. CEO Chronicles — bringing business, leadership, and decision-making into focus. Talent Nexus — celebrating performance, confidence, and individual talent. And Innovex — turning fresh ideas into innovative possibilities. With teams taking on each challenge and being evaluated throughout the event, every performance contributes to the final outcome. Six sub-events. Six different challenges. One competitive journey. Innovex 4.0 is coming back.", "voice_key": "voices/system/cmsq8i84w00011eg28n28u5ba"}' \
#   --output output.wav

# R2 cloud bucket mount (read-only, replaces Modal Volume)
R2_BUCKET_NAME = "sonance-app"
R2_ACCOUNT_ID = "d20d0a33e5e7504e91f1687f5794df1d"
R2_MOUNT_PATH = "/r2"
